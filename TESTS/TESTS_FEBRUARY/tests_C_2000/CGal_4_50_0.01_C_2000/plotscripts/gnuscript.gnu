...
set output '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/CGal_4_50_0.01_rc_inc_pa.eps'
unset key
set size 0.60, 1
...
set ytics 50
set mytics 5
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:3 w lp ls 1
set title ''
@MMARGIN
@NOXTICS
set yrange [43.8886:53.6417]
set ylabel 'i [deg]'
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:5 w lp ls 1
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [27.6174:33.7546]
set ylabel 'P.A. [deg]'
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:6 w lp ls 1
unset multiplot
set output '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/CGal_4_50_0.01_disp_vsys_z0.eps'
unset key
set xlabel 'Radius [arcsec]'
set xtics 200
set mxtics 2
...
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:4 w lp ls 1
@MMARGIN
@NOXTICS
set yrange [-10:10]
set ylabel 'V_{sys} [km/s]'
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:12 w lp ls 1
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [27:33]
set ylabel 'Scale height [arcsec]'
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt'u 2:8 w lp ls 1
unset multiplot
set output '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/CGal_4_50_0.01_xc_yc_cd.eps'
set multiplot layout 3,1 rowsfirst
@LABELF
@TICSF
@TMARGIN
...
set ylabel 'X_c [pix]'
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:10 w lp ls 1
@MMARGIN
@NOXTICS
set yrange [22.95:28.05]
set ylabel 'Y_c [pix]'
plot '/home/user/THESIS/tests_C_2000/CGal_4_50_0.01_C_2000/rings_final1.txt' u 2:11 w lp ls 1
