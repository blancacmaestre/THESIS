...
set output '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/CGal_2_70_0.01_rc_inc_pa.eps'
unset key
set size 0.60, 1
...
set ytics 50
set mytics 5
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:3 w lp ls 1
set title ''
@MMARGIN
@NOXTICS
set yrange [70.1541:85.7439]
set ylabel 'i [deg]'
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:5 w lp ls 1
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [26.8478:32.814]
set ylabel 'P.A. [deg]'
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:6 w lp ls 1
unset multiplot
set output '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/CGal_2_70_0.01_disp_vsys_z0.eps'
unset key
set xlabel 'Radius [arcsec]'
set xtics 200
set mxtics 2
...
set ytics 5
set mytics 5
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:4 w lp ls 1
@MMARGIN
@NOXTICS
set yrange [-10:10]
set ylabel 'V_{sys} [km/s]'
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:12 w lp ls 1
@BMARGIN
@XTICS
set xlabel 'Radius [arcsec]'
set yrange [27:33]
set ylabel 'Scale height [arcsec]'
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt'u 2:8 w lp ls 1
unset multiplot
set output '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/CGal_2_70_0.01_xc_yc_cd.eps'
set multiplot layout 3,1 rowsfirst
@LABELF
@TICSF
@TMARGIN
...
set ylabel 'X_c [pix]'
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:10 w lp ls 1
@MMARGIN
@NOXTICS
set yrange [11.25:13.75]
set ylabel 'Y_c [pix]'
plot '/home/user/THESIS/tests_resolution/CGal_2_70_0.01_E_nau/rings_final1.txt' u 2:11 w lp ls 1
